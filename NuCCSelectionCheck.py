...
makeDataMCHistogram(vx_stack, wgt_stack, dataMuonCandidates['vx'].to_numpy(), (0,300), 15, 'vx_notfiducial',  ['vx not fiducial cut','vx(cm)','Number of Events'])
makeDataMCHistogram(vy_stack, wgt_stack, dataMuonCandidates['vy'].to_numpy(), (-200,200), 15, 'vy_notfiducial',  ['vy not fiducial cut','vy(cm)','Number of Events'])
makeDataMCHistogram(vz_stack, wgt_stack, dataMuonCandidates['vz'].to_numpy(), (0,1000), 15, 'vz_notfiducial',  ['vz not fiducial cut','vz(cm)','Number of Events'])
