...
chi2bins = list(np.arange(0,1,1))+list(np.arange(1,2,.1))+list(np.arange(2,10,1))+list(np.arange(10,100,10))+list(np.arange(100,220,20))
...
makeDataMCHistogram(overlayPrimMuonChi2FlashInclusiveStack, overlayIsSelectedInclusiveWeights, dataInclusiveEvents['nu_flash_chi2'].to_numpy(), (0,2), 20, "InclusiveEventsPrimMuonFlashChi2Zoom", ["Flash Chi2", "Chi2", "Number of Events"])
