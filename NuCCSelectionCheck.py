...
maxFlashChi2 = 10
minNeutrinoScoreFlashFails = 0.06    #0.25
maxFlashChi2Ratio  = 5
PrimMuonTrkScore = 0.8

extInclusiveEvents = extMuonCandidates.query('isLongestTrack == True & isFiducial == True & nu_pdg == @numupdg & flash_chi2_ratio < @maxFlashChi2Ratio & nu_score > @minNeutrinoScore & daughters_start_contained == True & track_score > @PrimMuonTrkScore')

dirtInclusiveEvents = dirtMuonCandidates.query('isLongestTrack == True & isFiducial == True & nu_pdg == @numupdg & flash_chi2_ratio < @maxFlashChi2Ratio & nu_score > @minNeutrinoScore & daughters_start_contained == True & track_score > @PrimMuonTrkScore')

overlayInclusiveEvents = overlayMuonCandidates.query('isLongestTrack == True & isFiducial == True & nu_pdg == @numupdg & flash_chi2_ratio < @maxFlashChi2Ratio & nu_score > @minNeutrinoScore & daughters_start_contained == True & track_score > @PrimMuonTrkScore')

dataInclusiveEvents = dataMuonCandidates.query('isLongestTrack == True & isFiducial == True & nu_pdg == @numupdg & flash_chi2_ratio < @maxFlashChi2Ratio & nu_score > @minNeutrinoScore & daughters_start_contained == True & track_score > @PrimMuonTrkScore')
...
dirtInclusiveEvents_noChi2 = dirtMuonCandidates.query('isLongestTrack == True & isFiducial == True & nu_pdg == @numupdg & flash_chi2_ratio < @maxFlashChi2Ratio & nu_score > @minNeutrinoScore & nu_score > @minNeutrinoScoreFlashFails')

overlayInclusiveEvents_noChi2 = overlayMuonCandidates.query('isLongestTrack == True & isFiducial == True & nu_pdg == @numupdg & flash_chi2_ratio < @maxFlashChi2Ratio & nu_score > @minNeutrinoScore & nu_score > @minNeutrinoScoreFlashFails')
...
extInclusiveEvents_noChi2Ratio5 = extMuonCandidates.query('isLongestTrack == True & isFiducial == True & nu_pdg == @numupdg & nu_score > @minNeutrinoScore & daughters_start_contained == True & track_score > @PrimMuonTrkScore' )
dirtInclusiveEvents_noChi2Ratio5 = dirtMuonCandidates.query('isLongestTrack == True & isFiducial == True & nu_pdg == @numupdg & nu_score > @minNeutrinoScore & daughters_start_contained == True & track_score > @PrimMuonTrkScore')
overlayInclusiveEvents_noChi2Ratio5 = overlayMuonCandidates.query('isLongestTrack == True & isFiducial == True & nu_pdg == @numupdg & nu_score > @minNeutrinoScore & daughters_start_contained == True & track_score > @PrimMuonTrkScore')
dataInclusiveEvents_noChi2Ratio5 = dataMuonCandidates.query('isLongestTrack == True & isFiducial == True & nu_pdg == @numupdg & nu_score > @minNeutrinoScore & daughters_start_contained == True & track_score > @PrimMuonTrkScore')
...
#  & daughters_start_contained == True
...
chi2bins = list(np.arange(0,1,1))+list(np.arange(1,2,.1))+list(np.arange(2,15,1))+list(np.arange(15,120,15))+list(np.arange(120,220,20))
...
makeDataMCHistogram(overlayPrimMuonChi2FlashInclusiveStack, overlayIsSelectedInclusiveWeights, dataInclusiveEvents['nu_flash_chi2'].to_numpy(), (0,3), list(np.arange(0,1,1))+list(np.arange(1,2,.1)), "InclusiveEventsPrimMuonFlashChi2Zoom", ["Flash Chi2", "Chi2", "Number of Events"])
