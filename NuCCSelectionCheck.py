...
extInclusiveEvents_noChi2Ratio = extMuonCandidates.query('isLongestTrack == True')

dirtInclusiveEvents_noChi2Ratio = dirtMuonCandidates.query('isLongestTrack == True')

overlayInclusiveEvents_noChi2Ratio = overlayMuonCandidates.query('isLongestTrack == True')

dataInclusiveEvents_noChi2Ratio = dataMuonCandidates.query('isLongestTrack == True')
# #SAVE THIS
...
makeDataMCHistogram(chi2_phi, chi2_wgt, dataInclusiveEvents_noChi2Ratio['phi'].to_numpy(), phiRange, 64, "phi_1-0", ["phi only longest", "Angle / pi (radians)", "Number of Primary Muons"])
makeDataMCHistogram(chi2_nu, chi2_wgt, dataInclusiveEvents_noChi2Ratio['nu_score'].to_numpy(), trkScoreRange, 50, "nu_score_1-0", ["nu_score only longest", "Neutrino ID", "Number of Events"])
