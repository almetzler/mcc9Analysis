...
chi2bins = list(np.arange(0,0.6,0.6))+list(np.arange(0.6,2,0.2))+list(np.arange(2,4,0.5))+list(np.arange(4,15,1))+list(np.arange(15,40,5))+list(np.arange(40,220,20))
