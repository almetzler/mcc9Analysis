...
# print [type(x) for x in incPrimMuonNuScoreStack[:10]]
fig, axi = plt.subplots()
flat_nu = [x for x in y.tolist() for y in incPrimMuonNuScoreStack]
flat_chi = [x for x in y.tolist() for y in incPrimMuonChi2FlashStack]
