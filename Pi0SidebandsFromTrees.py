...
eventsWithShowers = pd.read_pickle("../Data/eventsOverlayShower.pkl")
...
dirtEventsWithShowers = pd.read_pickle("../Data/eventsDirtShower.pkl")
...
extEventsWithShowers = pd.read_pickle("../Data/eventsExtShower.pkl")
